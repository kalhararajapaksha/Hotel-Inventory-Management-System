<%@ Page Title="" Language="C#" MasterPageFile="~/Sidebar.Master" AutoEventWireup="true" CodeBehind="DailyGuestCount.aspx.cs" Inherits="HIMS_Frontend.ManageReservation" %>
                ...
                <div class="modal-body">
                    <form>
                        <div class="mb-3">
                            ...
                            <label class="col-form-label" for="recipient-name">Total Guests:</label><span style="color: red">*</span>
                            <input id="txtCatName" class="form-control" type="number" value="">
                        </div>
                    </form>
                </div>
